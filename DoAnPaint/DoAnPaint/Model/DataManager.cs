...
namespace DoAnPaint.Model
{
    ...
    public class DataManager
    {
        ...
        // chứa danh sách các hình vẽ
        public List<Shape> shapeList { get; set; }

        // chứa hình được chọn hiện tại
        public Shape shapeToMove { get; set; }

        // vẽ vùng được chọn có kích thước như đối tượng này 
        public System.Drawing.Rectangle rectangleRegion;

        // thiết lập trạng thái click chuột xuống của người dùng
        public bool isMouseDown { get; set; }

        // thiết lập trạng thái di chuyển hình của người dùng
        public bool isMovingShape { get; set; }

        // thiết lập trạng thái di chuyển chuột của người dùng
        public bool isMovingMouse { get; set; }

        // thiết lập trạng thái cho biết có phải người dùng đang vẽ đường cong hay không
        public bool isDrawingCurve { get; set; }

        // thiết lập trạng thái cho biết có phải người dùng đang vẽ đa giác hay không
        public bool isDrawingPolygon { get; set; }

        // thiết lập trạng thái cho biết có phải người dùng đang vẽ pencil hay không
        public bool isDrawingPen { get; set; }

        // thiết lập trạng thái cho biết có phải người dùng đang chọn chế độ eraser hay không
        public bool isDrawingEraser { get; set; }

        //thiết lập trạng thái cho biết có phải người dùng đang chọn chế độ fill hay không
        public bool isFill { get; set; }

        // thiết lập trạng thái cho biết có phải người dùng đã lưu hình hay chưa
        public bool isSave{ get; set; }

        // thiết lập trạng thái cho biết có background hiện tại được vẽ hay là chưa
        public bool isNotNone{ get; set; }

        // thiết lập trạng thái cho biết có phải người dùng chọn tất cả các hình hay là không
        public bool isSelectAll { get; set; }

        // cho biết điểm điều khiển nào người dùng muốn resize kích thước
        public int pointToResize { get; set; }

        //cho biết trạng thái hình hiện tại là hình nào
        public CurrentShapeStatus currentShape { get; set; }

        // cho biết vị trí con trỏ chuột hiện tại
        public Point cursorCurrent { get; set; }

        // chứa danh sách các hình
